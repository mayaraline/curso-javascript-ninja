(function(window, document){
    ...
    */
    $button.addEventListener('click', function(){
        ...
        var confirmSubmit = confirm('Tem certeza que deseja enviar o formulário?');
    ...
    */
    function isValidEmail(email) {
        var regexp = /^[\w\d_.+]+@\w+\.[A-Za-z]{2,}(?:\.[A-za-z]{1,2})?$/gmi;
        var regexpTest = new RegExp(regexp);
        return !!regexpTest.test(email);
    }
