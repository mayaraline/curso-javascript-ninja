(function() {
    ...
    */
    console.log( '\nOperation 2:' );
    var operation2 = justMod2Or3.reduce(function(previous, item, index, array) {
        return previous++ * item;
    });
    ...
    */
    ...
    var name = ['E', 'du', 'ar', 'do'];
    var reducedName = name.reduce(function(previous, item, index, array) {
    ...
    */
    ...
    var lastIndexOf = numberObjects.lastIndexOf({ number: 2 });
