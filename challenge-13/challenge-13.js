(function(){
    ...
    */
    var sul = ['Rio Grande do Sul', 'Santa Caratirna', 'Parana'];
    ...
    */
    ...
    var brasilHasCeara = brasil.map(function(item, index, array) {
        return item === 'Ceará';
    })
    console.log(brasilHasCeara ? 'Ceará está incluído!' : 'Ceará não foi incluído :(');
    ...
    */
    var par = newBrasil.filter(function(item, index, array){
        return (item.id % 2 === 0);
    })
